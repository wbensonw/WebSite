    ...
    dow: {
        ...
        analysis: {
            ...
            keyPoints: [
                ...
                '- 穩定期：1995-1999年連續5年上漲（年均+27.10%）',
                '- 近期表現：2023年強勁反彈（+24.23%）',
                '',
                '月度特性：',
                '- 最佳表現月：12月（平均+1.9%）、4月（平均+1.8%）',
                '- 最差表現月：9月（平均-1.2%）、8月波動較大',
                '- 年底效應：11-12月上漲機率分別為76.5%和79.4%，最強勁',
                '',
                '統計數據：',
                '- 月度上漲機率最高：12月（79.4%）',
                '- 月度上漲機率最低：9月（47.1%）',
    ...
    hsi: {
        ...
        analysis: {
            ...
            keyPoints: [
                ...
                '- 主要震盪：1997年10月重貶27.88%',
                '- 穩定期：2003-2007年連續5年上漲（年均+31.89%）',
                '- 近期表現：2021-2023連續三年下跌，累計-38.37%',
                '',
                '月度特性：',
                '- 最佳表現月：1月（平均+3.1%）、10月（平均+2.0%）',
                '- 最差表現月：8月（平均-2.4%）、9月（平均-2.2%）',
